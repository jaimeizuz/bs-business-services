...
@JsonPropertyOrder({
  WrapperGetResponseFileExtractionsData.JSON_PROPERTY_FILE_EXTRACTED_DATA
})
/**
  * Data structure containing information about a file.  This data structure is the response to a request to retrieve the metadata from a file extraction.
  */

public class WrapperGetResponseFileExtractionsData  implements Serializable {
  ...
  */
  ...
  public WrapperGetResponseFileExtractionsData fileExtractedData(String fileExtractedData) {
    this.fileExtractedData = fileExtractedData;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class WrapperGetResponseFileExtractionsData {\n");
