...
@JsonPropertyOrder({
  WrapperGetMetadata.JSON_PROPERTY_REQUEST_ID
})
/**
  * Data structure containing information about a generic request
  */

public class WrapperGetMetadata  implements Serializable {
  
  public static final String JSON_PROPERTY_REQUEST_ID = "requestId";
 /**
  * Unique request ID. The value is the file extraction ID for the extraction request.
  */
  ...
  public WrapperGetMetadata requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class WrapperGetMetadata {\n");
