...
package es.santander.scib.dummy.rest.client;

import es.santander.scib.gboentities.rest.client.ApiException;
import es.santander.scib.gboentities.rest.client.ApiExceptionMapper;
...
public interface DummyApi {
    ...
    Response getDummy() throws ApiException, ProcessingException;
